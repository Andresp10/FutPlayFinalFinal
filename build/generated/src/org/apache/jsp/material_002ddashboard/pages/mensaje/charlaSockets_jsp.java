package org.apache.jsp.material_002ddashboard.pages.mensaje;
...
public final class charlaSockets_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.add("/material-dashboard/pages/mensaje/../includes/importsCSS.jsp");
    _jspx_dependants.add("/material-dashboard/pages/mensaje/../includes/notificaciones.jsp");
    _jspx_dependants.add("/material-dashboard/pages/mensaje/../includes/sidebarJugador.jsp");
    _jspx_dependants.add("/material-dashboard/pages/mensaje/../includes/header.jsp");
    _jspx_dependants.add("/material-dashboard/pages/mensaje/../includes/importsJS.jsp");
  }
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <title>FurPlay - Charla Tecnica</title>\r\n");
      out.write("        ");
...
if(objJugador != null & objPersona != null){
      ...
      out.write("                    <div class=\"container-fluid\" id=\"containercharla\">\r\n");
      out.write("                        ");
if (objJugador.getEquipo().toString().equals("1")) {
      ...
      out.write("                                    <h6 class=\"category text-gray\">¿No tienes mensajes?</h6>\r\n");
      ...
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      out.write("                        <p id=\"sinMSJ\" style=\"display: none\">no</p>\r\n");
      out.write("                        ");
}else{
      out.write("\r\n");
      ...
      out.write("                                            <div class=\"card-content\" id=\"mensajesContainer\" style=\"height: 300px;overflow-y: auto;background-color: #e7e6e6;\">\r\n");
      out.write("                                                <ul class=\"timeline\" id=\"mensajes\">\r\n");
      out.write("                                                </ul>\r\n");
      out.write("                                            </div>\r\n");
      out.write("                                        </div>\r\n");
      out.write("                                    </div>\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                            <!--<textarea id=\"mensajesArea\" readonly=\"readonly\" rows=\"10\" cols=\"45\"></textarea><br>-->\r\n");
      out.write("                            <div class=\"col-md-12\">\r\n");
      out.write("                                <div class=\"row\">\r\n");
      out.write("                                    <div class=\"col-md-10 col-lg-offset-1\">\r\n");
      out.write("                                        <div class=\"form-group\">\r\n");
      out.write("                                            <label>Escribe un mensaje</label>\r\n");
      out.write("                                            <div class=\"form-group label-floating is-empty\">\r\n");
      out.write("                                                <textarea class=\"form-control\" rows=\"3\" id=\"txtContenidoMensaje\"></textarea>\r\n");
      out.write("                                            <span class=\"material-input\"></span></div>\r\n");
      out.write("                                        </div>\r\n");
      out.write("                                        <button class=\"btn btn-rose pull-right\" onclick=\"enviarMensaje()\">Enviar</button>\r\n");
      out.write("                                    </div>\r\n");
      out.write("                                </div>\r\n");
      out.write("                            </div>\r\n");
      out.write("                        </div>\r\n");
      ...
      out.write("\r\n");
      out.write("        <script>\r\n");
      out.write("            $(\"#charla\").addClass('active');\r\n");
      out.write("            $(\"#nombrepagina\").text(\"Charla tecnica\");\r\n");
      out.write("           \r\n");
      out.write("            var contenido;\r\n");
      out.write("            var mensaje;\r\n");
      out.write("           \r\n");
      out.write("            if($(\"#sinMSJ\").text() == \"no\"){\r\n");
      out.write("                \r\n");
      out.write("                $.notify({\r\n");
      out.write("                    icon: \"speaker_notes_off\",\r\n");
      out.write("                    message: \"Tus mensaje apareceran cuando hagas parte de un equipo.\"\r\n");
      out.write("\r\n");
      out.write("                },{\r\n");
      ...
      out.write("            }else{\r\n");
      out.write("                \r\n");
      out.write("                var websocket = new WebSocket(\"ws://localhost:8080/FutPlayFinal/salaChat\");\r\n");
      ...
      out.write("                    $(\"#mensajes\").html(\"\");\r\n");
      out.write("                    \r\n");
      out.write("                    if(jsonData.length == 0){\r\n");
      out.write("                        \r\n");
      out.write("                        $.notify({\r\n");
      out.write("                            icon: \"speaker_notes_off\",\r\n");
      out.write("                            message: \"Por el momento no tienes mensajes en tu bandeja de entrada.\"\r\n");
      out.write("\r\n");
      out.write("                        },{\r\n");
      ...
      out.write("                            }\r\n");
      out.write("                        });\r\n");
      out.write("                        $(\"#mensajes\").html(\"<li>\"\r\n");
      out.write("                                                + \"<div class='timeline-badge danger'>\"\r\n");
      out.write("                                                    + \"<i class='material-icons'>speaker_notes_off</i>\"\r\n");
      out.write("                                                + \"</div>\"\r\n");
      out.write("                                                + \"<div class='timeline-panel'>\"\r\n");
      out.write("                                                    + \"<div class='timeline-heading'>\"\r\n");
      out.write("                                                        + \"<span class='label label-danger'>FutPlay</span>\"\r\n");
      out.write("                                                    + \"</div>\"\r\n");
      out.write("                                                    + \"<div class='timeline-body'>\"\r\n");
      out.write("                                                        + \"<p>Por el momento no tienes mensajes en tu bandeja de entrada.</p>\"\r\n");
      out.write("                                                    + \"</div>\"\r\n");
      out.write("                                                    + \"<small class='category text-gray'>\"\r\n");
      out.write("                                                        + \"<i class='ti-time'></i> Justo ahora\"\r\n");
      out.write("                                                    + \"</small>\"\r\n");
      out.write("                                                + \"</div>\"\r\n");
      out.write("                                            +\"</li>\");\r\n");
      out.write("                    }else{\r\n");
      ...
      out.write("                        //mensajesArea.value += jsonData[i].Contenido + \"\\n\";\r\n");
      out.write("\r\n");
      out.write("                        var tipo=\"\";\r\n");
      out.write("                        var remitente=\"\";\r\n");
      out.write("                        var icono=\"\";\r\n");
      out.write("                        var color = \"\";\r\n");
      out.write("                        if (jsonData[i].Jugador.idJugador == ");
      out.print(objJugador.getIdJugador());
      out.write(") {\r\n");
      out.write("\r\n");
      out.write("                            tipo = \"<li class='timeline-inverted'>\";\r\n");
      out.write("                            remitente = \"Tú\";\r\n");
      out.write("                            icono = \"person\";\r\n");
      out.write("                            color = \"info\";\r\n");
      out.write("                        }else{\r\n");
      out.write("\r\n");
      out.write("                            tipo = \"<li>\";\r\n");
      out.write("                            remitente = jsonData[i].Jugador.Alias;\r\n");
      out.write("                            icono = \"people\";\r\n");
      out.write("                            color=\"warning\";\r\n");
      out.write("                        }\r\n");
      out.write("\r\n");
      out.write("                        $(\"#mensajes\").append(tipo\r\n");
      out.write("                                                + \"<div class='timeline-badge \"+color+\"'>\"\r\n");
      out.write("                                                    + \"<i class='material-icons'>\"+icono+\"</i>\"\r\n");
      out.write("                                                + \"</div>\"\r\n");
      out.write("                                                + \"<div class='timeline-panel'>\"\r\n");
      out.write("                                                    + \"<div class='timeline-heading'>\"\r\n");
      out.write("                                                        + \"<span class='label label-\"+color+\"'>\"+remitente+\"</span>\"\r\n");
      out.write("                                                    + \"</div>\"\r\n");
      out.write("                                                    + \"<div class='timeline-body'>\"\r\n");
      out.write("                                                        + \"<p>\"+jsonData[i].Contenido+\"</p>\"\r\n");
      out.write("                                                    + \"</div>\"\r\n");
      out.write("                                                    + \"<small class='category text-gray'>\"\r\n");
      out.write("                                                        + \"<i class='ti-time'></i> \"+jsonData[i].Fecha\r\n");
      out.write("                                                    + \"</small>\"\r\n");
      out.write("                                                + \"</div>\"\r\n");
      out.write("                                            +\"</li>\");\r\n");
      out.write("                        }\r\n");
      out.write("                        var div_msg = document.getElementById('mensajesContainer');\r\n");
      out.write("                        div_msg.scrollTop = div_msg.scrollHeight;\r\n");
      out.write("                        \r\n");
      out.write("                    }\r\n");
      out.write("                    \r\n");
      out.write("                };\r\n");
      ...
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            function enviarMensaje(){\r\n");
      out.write("                //alert(\"enviando mensaje...\");\r\n");
      out.write("                websocket.send(\"mensaje/\"+txtContenidoMensaje.value+\"~");
      out.print(objJugador.getIdJugador());
      out.write('~');
      out.print(objJugador.getEquipo());
      out.write("\");\r\n");
      out.write("                txtContenidoMensaje.value = \"\";\r\n");
      out.write("                //alert(\"mensaje enviado\");\r\n");
      out.write("            }\r\n");
      out.write("            \r\n");
      out.write("            window.onload = function (){\r\n");
      out.write("                \r\n");
      out.write("                //alert(\"Iniciando la sala...\");\r\n");
      out.write("                websocket.send(\"usuario/\"+");
      out.print(objJugador.getEquipo());
      out.write(");\r\n");
      out.write("                //alert(\"Sala iniciada.\");\r\n");
      out.write("                \r\n");
